...
/// constant assets are prefixed with [ka]

/// personal assets
const String mePath = "/personal";
const String kaMe = "$basePath$mePath/me.jpg";
const String kaLogo = "$basePath$mePath/logo.svg";
const String kaMess = "$basePath$mePath/mess.svg";
const String kaMessage = "$basePath$mePath/message.svg";
...
const String kaVcare = "$basePath$projectPath/pulse_x.png";
const String kaBrain = "$basePath$projectPath/brain.png";
const String kaKetaby = "$basePath$projectPath/Ketaby.png";
const String kaTasks = "$basePath$projectPath/notee.png";
const String kaJOBSQUE = "$basePath$projectPath/JOBSQUE.png";
...
const String kaAmitCerti = "$basePath$certificatePath/Amit.png";
const String kaMachineLearningCerti = "$basePath$certificatePath/AI.jpg";
const String kaOdcCerti = "$basePath$certificatePath/ODC.png";
const String kaUxCerti = "$basePath$certificatePath/UX.png";
